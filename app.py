...
def get_export_font(size, bold=False):
    candidates = [TAJAWAL_BOLD if bold else TAJAWAL_REGULAR, READEX_BOLD if bold else READEX_REGULAR]
    candidates += ([TAJAWAL_FONTS.get(800), READEX_FONTS.get(600)] if bold else [TAJAWAL_FONTS.get(300), READEX_FONTS.get(300)])
    candidates += [
...
__LOCAL_FONT_CSS__
    ...
    /* KONUHA compact swipe navigation */
    [data-testid="stRadio"] { width:100% !important; margin:8px 0 18px !important; }
    [data-testid="stRadio"] > div { width:100% !important; }
    [data-testid="stRadio"] div[role="radiogroup"] {
        direction:rtl !important; display:flex !important; flex-direction:row !important; flex-wrap:nowrap !important;
        align-items:center !important; gap:10px !important; overflow-x:auto !important; overflow-y:hidden !important;
        width:100% !important; box-sizing:border-box !important; padding:8px !important; margin:0 !important;
        scrollbar-width:none !important; -webkit-overflow-scrolling:touch !important;
        background:rgba(14,17,29,.88) !important; border:1px solid #292d40 !important; border-radius:18px !important;
    }
    [data-testid="stRadio"] div[role="radiogroup"]::-webkit-scrollbar { display:none !important; }
    [data-testid="stRadio"] div[role="radiogroup"] > label {
        box-sizing:border-box !important; flex:0 0 auto !important; width:fit-content !important; min-width:112px !important;
        height:42px !important; min-height:42px !important; padding:0 16px !important; margin:0 !important;
        display:inline-flex !important; align-items:center !important; justify-content:center !important;
        border:1px solid #303448 !important; border-radius:13px !important;
        background:linear-gradient(180deg,#171a2a,#10131f) !important; color:#eceef4 !important;
        white-space:nowrap !important; overflow:hidden !important; writing-mode:horizontal-tb !important;
    }
    ...
    [data-testid="stRadio"] div[role="radiogroup"] > label div {
        ...
        word-break:keep-all !important; overflow:visible !important; display:block !important; width:auto !important;
        line-height:1.2 !important; margin:0 !important; direction:rtl !important;
    }
    [data-testid="stRadio"] div[role="radiogroup"] > label:hover { border-color:#7654cf !important; }
